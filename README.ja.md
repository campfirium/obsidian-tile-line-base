...
* [Campfirium フォーラム](https://forum.campfirium.com/t/tilelinebase-v080-released-the-native-plain-text-database-for-obsidian/753) の議論に参加する。より広いアイデアや横道の話題も歓迎しています。
...
### Foliole: 取り組みやすいインクリメンタルリーディングアプリ

Obsidian は、ノートを集め、整理し、書くための優れたツールですが、多くのワークフローはその先へも広がっていきます。

TileLineBase が多次元テーブルと構造化されたレコードで Obsidian を拡張するなら、[Foliole](https://github.com/campfirium/foliole) は読書の後半段階を拡張します。資料を適切なタイミングで再び表示し、戻ってきたときに理解しやすくし、より効果的に記憶へ取り込み、読書を実際に完了できるようにします。
