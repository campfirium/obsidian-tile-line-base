...
### Foliole: 접근하기 쉬운 점진적 읽기 앱

Obsidian은 노트를 수집하고, 정리하고, 작성하는 데 뛰어나지만 많은 워크플로는 그 이후 단계로 계속 확장될 수 있습니다.

TileLineBase가 다차원 테이블과 구조화된 레코드로 Obsidian을 확장한다면, [Foliole](https://github.com/campfirium/foliole)은 읽기의 후반 단계를 확장합니다. 자료가 적절한 시점에 다시 나타나고, 돌아왔을 때 더 쉽게 이해되며, 기억에 더 효과적으로 들어가고, 읽기가 실제로 완료되도록 돕습니다.
